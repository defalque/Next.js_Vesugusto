function AccountHeading({ children, title, text, accessibleLabel }) {
  return (
    ...
    >
      <h1
        id={accessibleLabel}
        className="text-primary-dark-900 inline-flex max-w-fit min-w-fit flex-wrap items-center gap-2 text-4xl font-semibold sm:font-medium md:text-5xl dark:text-gray-200"
      >
        {children || title}
      </h1>
