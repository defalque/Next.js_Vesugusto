...
export default function FavoriteCard({ favorite, children }) {
  return (
    <div className="relative flex flex-col gap-2">
      <div className="order-2 flex flex-col gap-1 text-base text-gray-800 sm:text-base dark:text-gray-300">
      ...
      <Link
        className="focus order-1 rounded-lg transition-opacity duration-200 hover:opacity-85 focus:outline-4"
