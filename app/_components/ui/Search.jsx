...
export default function Search({ placeholder }) {
  ...
  return (
    <div className="relative flex flex-1">
      ...
      <input
        id="search"
        className="peer focus:border-primary-950 focus:ring-primary-950/20 _sm:text-sm block w-full rounded-xl border border-gray-200 bg-white/80 py-2 pr-10 pl-10 text-base shadow-xs backdrop-blur-xs transition-colors duration-200 placeholder:text-zinc-500 focus:ring-2 focus:outline-none dark:border-zinc-700 dark:bg-black/80 dark:placeholder:text-zinc-500"
