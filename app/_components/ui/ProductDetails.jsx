...
async function ProductDetails({ product }) {
  ...
  return (
    <div className="flex flex-col gap-3 ml-3">
      <h1 className="text-3xl lg:text-5xl font-medium pb-5 border-b border-b-zinc-200 dark:border-b-dark-200">
        {product.name}
      </h1>
      ...
      <p className="text-base lg:text-lg text-zinc-500 dark:text-gray-300 mb-10">
        {product.description}
      </p>
