...
export function CartProductsListSkeleton() {
  return (
    <div className="grid min-h-screen grid-cols-1 grid-rows-[auto_1fr] gap-x-10 gap-y-8 lg:grid-cols-[1.5fr_1fr] lg:grid-rows-[auto]">
...
export function UpdateProfileFormSkeleton() {
  return (
    <form className="my-8 flex flex-col gap-4 text-xs sm:text-sm md:text-base">
      {/* Nome ed Email */}
...
function OrderCardItemSkeleton() {
  return (
    <div
      className={`grid grid-cols-[auto_1fr] grid-rows-[auto_auto_auto_auto_auto] gap-x-3 px-3 py-4 font-light sm:grid-cols-[auto_minmax(0,1fr)_auto] sm:grid-rows-[auto_auto_auto_auto] sm:gap-x-5 md:grid-rows-[auto_auto_auto] md:px-5 lg:py-8 xl:px-10`}
    >
      {/* Image Skeleton */}
      ...
      {/* Product Name */}
      <div
        className={`${shimmer} relative h-5 w-1/6 overflow-hidden rounded-xl bg-gray-200 dark:bg-zinc-700`}
      />

      {/* Price */}
      <div
        className={`${shimmer} relative h-5 w-16 overflow-hidden rounded-xl bg-gray-200 sm:justify-self-end dark:bg-zinc-700`}
      />

      {/* Description */}
      <div
        className={`${shimmer} relative col-span-2 -row-start-1 mt-2 h-16 overflow-hidden rounded-xl bg-gray-200 sm:row-start-2 sm:mt-0 dark:bg-zinc-700`}
      />

      {/* Quantity */}
      <div
        className={`${shimmer} relative col-start-2 row-start-3 h-4 w-24 self-end overflow-hidden rounded-xl bg-gray-200 dark:bg-zinc-700`}
      />
      ...
      <div className="text-primary-950 col-start-2 row-start-4 flex flex-wrap items-center gap-3 self-end text-sm font-semibold md:col-start-3 md:row-start-3">
        <div
          className={`${shimmer} relative h-5 w-24 overflow-hidden rounded-xl bg-gray-200 dark:bg-zinc-700`}
        />
        <div
          className={`${shimmer} relative h-5 w-24 overflow-hidden rounded-xl bg-gray-200 dark:bg-zinc-700`}
        />
...
export function FavoritesListSkeleton() {
  return (
    <div className="grid grid-cols-2 gap-x-10 gap-y-20 sm:gap-x-20 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
