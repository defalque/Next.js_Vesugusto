  ...
  return (
    <div className="w-40 self-center rounded-xl bg-white/80 backdrop-blur-xs dark:bg-black/80">
      ...
      <select
        ...
        className="focus-visible:outline-primary-950 outline-primary-dark-100 block w-full rounded-xl border border-gray-200 px-0 py-2 text-sm transition-colors duration-200 hover:border-gray-300 focus-visible:outline-2 dark:border-zinc-700 dark:hover:border-zinc-600"
      >
