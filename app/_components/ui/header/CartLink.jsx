...
async function CartLink() {
  ...
  return (
    <NavLink href="/cart" type="main" aria-label="Carrello">
      <ShoppingCart
        aria-hidden
        className="text-primary-dark-900 dark:text-primary-50 _relative _block inline size-6 transition-colors duration-300 md:size-5"
      />
      {cartItems > 0 && (
        <span
