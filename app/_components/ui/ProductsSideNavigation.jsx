  ...
  return (
    <div
      className={`${
        isHidden
          ? "hidden"
          : "fixed inset-0 top-0 left-0 w-full min-h-screen z-1000 bg-primary-50 dark:bg-primary-dark-950 md:relative md:z-40"
      }`}
    >
...
//           className="fixed inset-0 top-0 left-0 w-full min-h-screen z-1000 bg-primary-50 dark:bg-primary-dark-950 md:relative md:z-100"
//         >
//           <div className="flex flex-col px-1.5 lg:px-3 py-2 mt-2 text-md md:sticky font-normal top-15 w-full">
//             <div className="border-b py-3 border-b-zinc-200 dark:border-b-dark-200 ml-1.5 lg:ml-3">
//               <XMarkIcon
...
//                 <span>Categoria</span>
//                 {category ? (
//                   <ChevronDownIcon className="ml-auto size-6 md:size-4.5" />
//                 ) : (
//                   <ChevronRightIcon className="ml-auto size-6 md:size-4.5" />
//                 )}
//               </div>
...
//                           checked={activeTypeFilters.includes(type.type)}
//                           onChange={() =>
//                             handleMultiFilterClick("type", type.type)
//                           }
//                           className="mr-2"
//                         />
//                         <span className="text-primary-dark-900 dark:text-primary-50 font-light">
...
//                           checked={activePriceFilters.includes(value)}
//                           onChange={() =>
//                             handleMultiFilterClick("price", value)
//                           }
//                           className="w-4 h-4 cursor-pointer"
//                         />
//                         <span className="text-primary-dark-900 dark:text-primary-50 font-light">
