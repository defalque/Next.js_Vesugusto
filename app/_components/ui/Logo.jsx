  ...
  return (
    ...
    >
      <Image
        ...
        height={40}
        alt="Logo Vesugusto"
        className={`${isFooter ? "hidden" : "inline"} rounded-full border border-gray-200 md:hidden dark:border-none dark:bg-gray-50`}
        priority
      ></Image>
      <span className="sr-only">Vesugusto</span>

      <span
        className={`${isFooter ? "" : "hidden"} text-5xl font-bold md:inline`}
        aria-hidden="true"
      >
        V
      </span>
      {complete && (
        <span
          className={`${isFooter ? "" : "hidden"} text-4xl font-bold tracking-wider md:inline`}
          aria-hidden="true"
        >
          esugusto
        </span>
